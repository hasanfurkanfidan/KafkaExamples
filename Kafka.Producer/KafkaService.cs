...
namespace Kafka.Producer
{
    public class KafkaService
    {
        ...
        public async Task SendComplexMessageWithIntKeyAndHeader(string topicName)
        {
            var config = new ProducerConfig()
            {
                BootstrapServers = "localhost:9094"
        ...
        public async Task SendComplexMessageWithComplexKey(string topicName)
        {
            var config = new ProducerConfig()
            {
                BootstrapServers = "localhost:9094"
        ...
        public async Task SendComplexMessageWithTimeStamp(string topicName)
        {
            var config = new ProducerConfig()
            {
                BootstrapServers = "localhost:9094"
        ...
        public async Task SendComplexMessageWithAcknowledge(string topicName)
        {
            var config = new ProducerConfig()
            {
                BootstrapServers = "localhost:9094",
